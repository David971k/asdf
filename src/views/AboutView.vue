  ...
  <main>
    <div class="main">
      <div class="text">
        <h2>О нас</h2>
        <p>
          <span>LAST REVISED: April 9, 2021</span><br>
          <span>1. Acceptance of NFT Terms; Modification of NFT Terms</span>
          <p>
            Welcome to the Triller NFT Platform owned and operated by Triller, Inc., whose address is at 2121 Avenue of the Stars Suite 2350, Los Angeles, California 90067 (“Company”, “we”, “us”, or “our”). 
            These Terms and Conditions (“NFT Terms”) constitute a legally binding agreement between Company and each registered or unregistered end user (each, a “User”, “you” or “your”) of the Triller NFT 
            Platform located at nft.triller.co or trillfernfts.com or such other URL as may be designated by Company from time to time, as well as any mobile apps or other related services or applications 
            thereto (collectively, the “NFT Platform”).  
            The NFT Platform is considered part of the “Platform” as defined in the Triller.co Terms of Service (“Platform Terms”) set forth here.[1]  The Platform Terms are incorporated by reference into 
            these NFT Terms, and govern your use and access of the NFT Platform.  In the event of a conflict between these terms of these NFT Terms and the Platform Terms, the NFT Terms will supersede and control. 
            Please carefully review these NFT Terms and the Platform Terms.  By accessing and using the NFT Platform (including by creating an Account (as defined in the Platform Terms) or by purchasing or
            bidding on any items herein), you are deemed to have read, accepted, executed and agreed to be bound by these NFT Terms (including the Platform Terms as incorporated by reference herein).  
            We may change or amend the NFT Platform or these NFT Terms at any time at our 
            sole and absolute discretion. Any changes to the NFT Terms will be in effect as of the “LAST REVISED” date referred to at the top of this page.  
            You acknowledge and agree that the form and nature of the NFT Platform, and any part of it, may change from time to time without prior notice to you, 
            and that we may add new or remove existing features and change any part of the NFT Platform.
          </p>
          <span>2. Certain Definitions</span>
          <p>
            Any capitalized terms used but not defined in these NFT Terms will have the meaning set forth in the Platform Terms.  For the purposes of these NFT Terms, the following capitalized terms will have the following meanings:
...
“Third Party IP” means any third party copyrights, trade secrets, trademarks, know-how, patent rights or any other intellectual property rights recognized in any country or jurisdiction in the world.
          ...
          <span>3. NFT Purchases</span>
          <p>
            The NFT Platform allows you to bid on, purchase and otherwise transact in Company NFTs.  Any Company NFT that you acquire on the NFT Platform is not hosted or stored by Company, but will be in your possession such as in your designated cryptocurrency wallet, and your ownership of the Company NFT will recorded on the applicable blockchain.  Company has no obligation or liability to you for keeping, storing, or helping you recover any Company NFT that you purchase hereunder.   
...
Company may provide a “Buy Now” feature that allows you to pay for a Company NFT at a specific price without bidding during an auction. If you purchase such a lot at the “Buy Now” price, these NFT Terms and auction terms will apply to the purchase or bid in the same manner as if you had been the successful bidder in an auction for that Company NFT.
          ...
          <span>6. Verification and Payment</span>
          <p>
            In the event you are a winning purchaser of a Company NFT, you must pay the purchase price within 1 business day after the close of the auction, or such other time as may be specified in the particulars of the Company NFT auction or sale. 
...
You will be solely responsible to pay any and all sales, use, value-added and other taxes, duties, and assessments (except taxes on our net income) now or hereafter claimed or imposed by any governmental authority associated with your use of the NFT Platform or Company NFTs, except for income taxes levied on us as a result of any such purchases of Company NFTs.
          ...
          <span>7. Assumption of Risks</span>
          <p>
...
We will not be liable or responsible to you, nor be deemed to have defaulted under or breached these NFT Terms, for any failure or delay in fulfilling or performing any of our obligations under these NFT Terms or in operating the NFT Platform,  when and to the extent such failure or delay is caused by or results from any events beyond Company’s ability to control, including acts of God; flood, fire, earthquake, epidemics, pandemics, tsunami, explosion, war, invasion, hostilities (whether war is declared or not), terrorist threats or acts, riot or other civil unrest, government order, law, or action, embargoes or blockades, strikes, labor stoppages or slowdowns or other industrial disturbances, shortage of adequate or suitable Internet connectivity, telecommunication breakdown or shortage of adequate power or electricity, and other similar events beyond our control.
          ...
          <span>8. Contact</span>
          <p>
            General questions or comments about the NFT Platform or these NFT Terms should be sent either by mail to Curios, Inc., 2121 Avenue of the Stars Suite 2350, Los Angeles, California 90067, or email to Support@curios.com
          </p>
        </p>
      </div>
    </div>
